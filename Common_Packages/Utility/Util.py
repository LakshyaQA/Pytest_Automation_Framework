...
class Util(object):
    ...
    def sleep(self, sec, info=""):
        ...
        """
        if info is not None:
            self.logg.info("Wait :: '" + str(sec) + "' seconds for " + info)
        try:
            time.sleep(sec)
    ...
    def verifyTextContains(self, actualText, expectedText):
        ...
        """
        self.logg.info("Actual Text From Application Web UI --> :: " + actualText)
        self.logg.info("Expected Text From Application Web UI --> :: " + expectedText)
        if expectedText.lower() in actualText.lower():
            self.logg.info("### VERIFICATION CONTAINS !!!")
            return True
        else:
            self.logg.info("### VERIFICATION DOES NOT CONTAINS !!!")
            return False
    ...
    def verifyTextMatch(self, actualText, expectedText):
        ...
        if actualText.lower() == expectedText.lower():
            self.logg.info("### VERIFICATION MATCHED !!!")
            return True
        else:
            self.logg.info("### VERIFICATION DOES NOT MATCHED !!!")
            return False
